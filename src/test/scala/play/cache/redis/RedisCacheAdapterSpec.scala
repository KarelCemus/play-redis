 ...
 */
class RedisCacheAdapterSpec extends Specification with RedisCacheSupport with BeforeAfterAll {
...
//    application.injector.instanceOf[ CachePlugin ].onStart()
  }

  override def afterAll( ): Unit = {
//    println("===== = = = = == =  =stopping")
//    application.injector.instanceOf[ CachePlugin ].onStop()
  }
}
