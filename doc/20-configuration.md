...
Default configuration and very detailed manual is available in [reference.conf](https://github.com/KarelCemus/play-redis/blob/2.5.1/src/main/resources/reference.conf). It can be overwritten in your `conf/application.conf` file.
